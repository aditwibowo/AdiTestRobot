...
App.factory('Session', function($http) {
  var Session = {
    ...
    saveSession: function() { 
		...
		$http.post( "insert.php" ).success(function() {
...
App.controller('reportCtrl', function($scope,$http) {
    ...
    var loadDB = "/db.php";
    $http.get( site+loadDB ).success(function(response) {
...
App.controller("viewportCtrl", function($scope, viewportService) {
	$scope.viewport = viewportService.CreateGrid();
